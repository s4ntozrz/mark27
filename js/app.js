document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedText) {
        ...
        const initialText = `# Documento Acadêmico\n\nEste é um parágrafo justificado para demonstração. Escreva em Markdown e acompanhe a visualização do seu documento. Quando estiver pronto, salve o arquivo ou gere um PDF pelo navegador.\n\n## Subtítulo Importante\n\n- Lista de itens;\n- Segundo item;\n  - Item aninhado.\n\n### Tabela de Dados\n\n| Variável | Valor | Observação |\n|----------|-------|------------|\n| Alpha    | 0.95  | Controle   |\n| Beta     | 1.20  | Tratamento |`;
